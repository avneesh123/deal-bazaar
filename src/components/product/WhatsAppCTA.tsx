...
import { getWhatsAppUrl, WHATSAPP_NUMBER, BRAND_EMAIL } from "@/lib/utils";
  ...
  return (
    <div className="border-t border-dark-border pt-6 mt-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Button
          href={getWhatsAppUrl(WHATSAPP_NUMBER, productName)}
          variant="whatsapp"
          external
        >
        ...
        <Button href={`mailto:${BRAND_EMAIL}?subject=Inquiry: ${productName}`} variant="secondary" external>
          Email Us
        </Button>
      </div>
    </div>
